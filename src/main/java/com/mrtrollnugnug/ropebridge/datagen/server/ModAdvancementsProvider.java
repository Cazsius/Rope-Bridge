...
public class ModAdvancementsProvider extends AdvancementProvider {
	...
	public static class ModAdvancementGenerator implements AdvancementSubProvider {
		...
		@Override
		public void generate(Provider provider, Consumer<AdvancementHolder> writer) {
			//Root advancement
			...
			AdvancementHolder craftBridge = Advancement.Builder.advancement()
				...
				.save(writer, rootID("craft_bridge_builder"));
			...
			AdvancementHolder buildBridge = Advancement.Builder.advancement()
				...
				.save(writer, rootID("build_bridge"));
			...
			AdvancementHolder craftLadder = Advancement.Builder.advancement()
				...
				.save(writer, rootID("craft_ladder_builder"));
			...
			AdvancementHolder buildLadder = Advancement.Builder.advancement()
				...
				.addCriterion("build_ladder", CriteriaTriggers.IMPOSSIBLE.createCriterion(new ImpossibleTrigger.TriggerInstance()))
				.save(writer, rootID("build_ladder"));
		}
		...
		protected static DisplayInfo rootDisplay(ItemLike icon, String titleKey, String descKey, Identifier background) {
			return new DisplayInfo(new ItemStackTemplate(icon.asItem()),
				...
				Optional.of(new ClientAsset.ResourceTexture(background)), AdvancementType.TASK, true, false, false);
		}
