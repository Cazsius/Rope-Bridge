...
public class ConfigurationHandler
{
    ...
    public static void syncConfig()
    {
        ...
        zoomOnAim = config.getBoolean("zoomOnAim", Configuration.CATEGORY_GENERAL, false, "WARNING - might cause problems with optifine. Due to restrictions in Minecrafts code, you won't be able to change your fov once enabled either.");
