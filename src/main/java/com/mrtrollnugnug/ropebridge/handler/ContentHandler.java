...
import com.mrtrollnugnug.ropebridge.block.RopeZipline;
...
import com.mrtrollnugnug.ropebridge.item.ItemZiplineBuilder;
...
public final class ContentHandler
{
    ...
    // Blocks
	private static Block ropeZipline;
    ...
    private static Item itemBridgeBuilder, itemLadderBuilder, itemZiplineBuilder;

    private static Item itemRope, itemBridgeHook, itemBarrel, itemHandle, itemLadderHook, itemZiplineHook;
    ...
    public static void initBlocks()
    {
        ...
        ropeZipline = ModUtils.registerBlockNoItem(new RopeZipline(Material.CLOTH), "rope_zipline");
        setBlockRopeLadder(ModUtils.registerBlockNoItem(new RopeLadder(Material.WOOD), "rope_ladder"));
    ...
    public static void initItems()
    {
        ...
        itemZiplineBuilder = ModUtils.registerItem(new ItemZiplineBuilder(), "zipline_builder");
        ...
        itemZiplineHook = ModUtils.registerItem(new Item(), "zipline_hook");
    ...
    {
    	GameRegistry.addRecipe(new ItemStack(itemZiplineBuilder), new Object [] { "tbh", 't', new ItemStack(itemZiplineHook), 'b', new ItemStack(itemBarrel), 'h', new ItemStack(itemHandle) });
        ...
        GameRegistry.addRecipe(new ItemStack(itemLadderHook), new Object[] { "l   ", "iii", "l  ", 'l', Blocks.LADDER, 'i', Items.IRON_INGOT });
        GameRegistry.addRecipe(new ItemStack(itemZiplineHook), new Object[] { "r  ", "iii", "r  ", 'r', new ItemStack(itemRope), 'i', Items.IRON_INGOT });
    ...
    public static void onClientPreInit()
    {
        ...
        ModUtils.registerItemInvModel(itemZiplineBuilder);
        
        ModUtils.registerItemInvModel(itemZiplineHook);
