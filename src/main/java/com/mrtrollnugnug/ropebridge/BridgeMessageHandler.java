        ...
        mainThread.addScheduledTask( () -> {
            ...
            switch (message.command) {
                case 0: { // Sound
                     ...
                     * world.playSoundAtEntity(player, name, 1.0F, world.rand.nextFloat() *
                     * 0.1F + 0.9F); } else { // Sound at coordinates
                     * world.playSoundEffect(message.posX, message.posY, message.posZ, name,
                     * 1.0F, world.rand.nextFloat() * 0.1F + 0.9F); } break;
                     */
                }
                case 1: { // set a block
