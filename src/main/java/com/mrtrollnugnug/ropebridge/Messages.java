...
public class Messages {
    ...
    // Oops! Looks like there's something in the way. Look for the Smoke to see where that is
    // and try again.
    public static final String OBSTRUCTED = "chat.ropebridge.info.obstruction";

    // "You need at least " + slabsNeeded + " slabs and " + stringNeeded + " strings to build
    // this bridge."
