...
public final class Constants {
	...
	public static final String CLIENT_PROXY_CLASS = "com.mcmoddev.ropebridge.client.ClientProxy";
	public static final String SERVER_PROXY_CLASS = "com.mcmoddev.ropebridge.common.CommonProxy";
