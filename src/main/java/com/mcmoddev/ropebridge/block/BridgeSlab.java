...
import com.mcmoddev.ropebridge.handler.ConfigurationHandler;
...
public class BridgeSlab extends Block {
	...
	public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		...
		stack.add(new ItemStack(Blocks.WOODEN_SLAB, (int) Math.floor(ConfigurationHandler.getSlabsPerBlock() / 2), slabMeta));
		stack.add(new ItemStack(ContentHandler.itemRope, (int) Math.ceil(ConfigurationHandler.getStringPerBlock() / 2)));
		return stack;
	}
